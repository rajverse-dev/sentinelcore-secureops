export const dashboardStats = [
  { label: 'Assets Monitored', value: '0', trendTime: 'from asset service', icon: 'ðŸ“Š' },
  { label: 'Uptime', value: '99.99%', trend: '+0.01%', trendTime: 'this month', icon: 'âœ…' },
  { label: 'Active Alerts', value: '12', trend: '-3', trendTime: 'from yesterday', icon: 'âš ï¸' },
  { label: 'Healthy Assets', value: '2,823', trend: '+5', trendTime: 'this week', icon: 'ðŸ’š' },
  { label: 'Warning Assets', value: '10', trend: '-1', trendTime: 'from yesterday', icon: 'âš¡' },
  { label: 'Critical Assets', value: '14', trend: '+2', trendTime: 'from yesterday', icon: 'ðŸ”´' },
  { label: 'CPU Usage', value: '23%', trend: '-2%', trendTime: 'average', icon: 'âš™ï¸' },
  { label: 'Memory Usage', value: '47%', trend: '+1%', trendTime: 'average', icon: 'ðŸ§ ' }
];
...
export const quickSnapshotMetrics = [
  { label: 'System Availability', value: '99.99%', status: 'Healthy', icon: 'â¬†ï¸' },
  { label: 'Network Health', value: '98.7%', status: 'Healthy', icon: 'ðŸŒ' },
  { label: 'Cloud Health', value: '97.8%', status: 'Healthy', icon: 'â˜ï¸' },
  { label: 'Automation Coverage', value: '87%', status: 'Healthy', icon: 'ðŸ¤–' },
  { label: 'Resource Efficiency', value: '92%', status: 'Healthy', icon: 'ðŸ“ˆ' }
];
