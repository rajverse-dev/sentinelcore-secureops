...
export default function LoginPage() {
  ...
  // Redirect already-authenticated users away from the login page, or pre-fill registered email
  useEffect(() => {
    if (storage.getToken()) {
    ...
    try {
      ...
      if (err && typeof err === 'object') {
        ...
        if (axiosError.response?.data) {
          ...
          message = 'Unable to connect to the authentication service. Please make sure the backend is running.';
